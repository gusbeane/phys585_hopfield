...
if __name__ == '__main__':
    ...
    for i in range(len(test_keys)):
        ...
        plt.imshow(test_img)
        plt.savefig('images_1train/input_test_'+str(i)+'.png')
        plt.close()
    ...
    for i in range(len(train_keys)):
        ...
        plt.savefig('images_1train/train_'+str(i)+'.png')
        plt.close()

    h = hopfield(train_images[[3]], test_images, theta=0, nprocess=5000, storkey=False)
    ...
    for i in range(len(retrain_img)):
        ...
        plt.imshow(img)
        plt.savefig('images_1train/retrain_'+str(i)+'.png')
        plt.close()
    ...
    for i in range(len(test_keys)):
        ...
        plt.imshow(test_img)
        plt.savefig('images_1train/test_'+str(i)+'.png')
        plt.close()

        plt.imshow(proc_img)
        plt.savefig('images_1train/proc_'+str(i)+'.png')
        plt.close()