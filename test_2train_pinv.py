...
if __name__ == '__main__':
    ...
    for i in range(len(test_keys)):
        ...
        plt.imshow(test_img)
        plt.savefig('images_2train_pinv/input_test_'+str(i)+'.png')
        plt.close()
    ...
    for i in range(len(train_keys)):
        ...
        plt.savefig('images_2train_pinv/train_'+str(i)+'.png')
        plt.close()

    h = hopfield(train_images[[1,3]], test_images, theta=0, nprocess=5000, storkey=False, pseudoinverse=True)
    ...
    for i in range(len(retrain_img)):
        ...
        plt.imshow(img)
        plt.savefig('images_2train_pinv/retrain_'+str(i)+'.png')
        plt.close()
    ...
    for i in range(len(test_keys)):
        ...
        plt.imshow(test_img)
        plt.savefig('images_2train_pinv/test_'+str(i)+'.png')
        plt.close()

        plt.imshow(proc_img)
        plt.savefig('images_2train_pinv/proc_'+str(i)+'.png')
        plt.close()
    ...
    plt.ylabel('energy')
    plt.tight_layout()
    plt.savefig('images_2train_pinv/proc_0_energy_vs_t.png')
